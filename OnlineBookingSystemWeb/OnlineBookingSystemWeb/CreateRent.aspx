<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="CreateRent.aspx.cs" Inherits="OnlineBookingSystemWeb.CreateRent" %>
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="CreateRent.aspx">Create Rent</a></li>
            ...
            <form id="form1" runat="server">
             ...
             <div class="form-group">
              ...
              <label>Description: <span class="text-danger">*</span></label>
                ...
                <asp:Button class="btn btn-primary" ID="CreateRentButton" runat="server" Text="Create Now" OnClick="CreateRentButton_Click" />
                 </div>
