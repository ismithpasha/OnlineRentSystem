<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RentDetails.aspx.cs" Inherits="OnlineBookingSystemWeb.RentDetails" %>
...
<div class="container">
    ...
    <div class="col-sm-10 col-sm-offset-1 ">
       ...
       <p><b>Posted On: </b>  <asp:Label ID="PostedOnLabel" runat="server" Text="Label"></asp:Label> </p>
        ...
        <p><b>Posted By: </b> <asp:Label ID="OwnerNameLabel" runat="server" Text="Label"></asp:Label> </p>
                      </div>
                      <div class="col-sm-6"> 
                  ...
                  <div class="form-group text-center">
                      ...
                      <asp:Button class="btn btn-primary pull-left" ID="ConfirmRentButton" runat="server" Text="Book Now" OnClick="ConfirmRentButton_Click"  />
                       <asp:Button class="btn btn-info pull-right" ID="EditRentButton" runat="server" Text="Edit Post" OnClick="EditRentButton_Click"   />
                       <asp:Button class="btn btn-danger pull-right" ID="DeleteRentButton" runat="server" Text="Delete Post" OnClick="DeleteRentButton_Click"  />
                      
                       
                      <asp:Button class="btn btn-primary pull-right" ID="CancelRentButton" runat="server" Text="Cancel" OnClick="CancelRentButton_Click"  />
                 </div>
